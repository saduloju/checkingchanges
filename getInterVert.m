function [SurfacesI,numSI] = getInterVert(NodeTable,nodeendR,nodeAR,nodeAL, ...
...
nodeARx = NodeTable2(nodeAR,2);
nodeBRx = NodeTable2(nodeBR,2);
% nodeAL = b+1;
nodeBL = nodeAL+nodeincL;
nodeALx = NodeTable2(nodeAL,2);
nodeBLx = NodeTable2(nodeBL,2);
% elemL = a+1;
% elemR = n1*(m1-1)+1;
